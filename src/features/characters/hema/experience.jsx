...
export const Experience = React.memo(({ disableWave = false, suppressSpeech = false }) => {
  return (
    <Canvas
      shadows
      camera={{
  ...
  <Hema position={[0, -2.2, 0]} scale={2} disableWave={disableWave} suppressSpeech={suppressSpeech} />
